...
class JHCameraTransitionDelegate:NSObject, UIViewControllerTransitioningDelegate {
    ...
    func presentationController(forPresented presented: UIViewController, presenting: UIViewController?, source: UIViewController) -> UIPresentationController? {
        JHCameraPresentationViewController(presentedViewController: presented, presenting: presenting)
    }
    
    // 出场动画
    func animationController(forPresented presented: UIViewController, presenting: UIViewController, source: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        let animate = JHCameraAnimatedTransitioning()
...
class JHCameraAnimatedTransitioning:NSObject, UIViewControllerAnimatedTransitioning {
 ...
 */
class JHCameraPresentationViewController:UIPresentationController, UIAdaptivePresentationControllerDelegate {
